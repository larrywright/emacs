...
(custom-set-faces
   ...
   ((((class color))
     (
      :inherit variable-pitch
               :background "DarkRed"
               :foreground "White"
               :family (eval emacs-english-font)
               ))))
 ;; Showtip
 '(showtip-face
   ((((class color)) (:inherit tooltip
                               :background "#730D0D"
                               :foreground "White"
                               :height 1.0
                               :family (eval emacs-english-font)))))
 ...
 '(eperiodic-period-number-face         ;周期数
   ((t (:foreground "grey"
                    :weight bold))))
 ;; Company-mode
 '(company-common-face                  ;相同的部分
   ((((class color) (background dark))
     (:background "khaki"
                  :foreground "black"))))
 '(company-expand-face                  ;展开的部分
   ((((class color) (background dark))
     (:background "DarkOrchid4"
                  :foreground "Gray60"))))
 '(company-last-expansion-face          ;选择TOP以后
   ((((class color) (background dark))
     (:background "DarkRed"
                  :foreground "Grey"))))
 '(company-pseudo-tooltip-face          ;假Tooltip
   ((t (:inherit default
                 :background "Gray30"
                 :foreground "Gold3"))))
 '(company-pseudo-tooltip-selection-face ;假Tooltip选择显示
   ((t (:inherit company-pseudo-tooltip-face
                 :background "orange"
                 :foreground "Black"))))
 '(company-tooltip-selection-face       ;Tooltip显示
   ((t (:background "orange"
                    :foreground "Black"))))
 ;; cal-china-x
